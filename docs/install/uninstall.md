...
If you used `npm install -g @termix-it/cryptoclaw@latest` or `npm install -g @termix-it/cryptoclaw@latest`, the CLI was installed with `npm install -g openclaw@latest`.
