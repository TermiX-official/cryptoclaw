...
const SANDBOX_EXAMPLES = {
  main: [
    ["cryptoclaw sandbox list", "List all sandbox containers."],
    ["cryptoclaw sandbox list --browser", "List only browser containers."],
    ["cryptoclaw sandbox recreate --all", "Recreate all containers."],
    ["cryptoclaw sandbox recreate --session main", "Recreate a specific session."],
    ["cryptoclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["cryptoclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["cryptoclaw sandbox list", "List all sandbox containers."],
    ["cryptoclaw sandbox list --browser", "List only browser containers."],
    ["cryptoclaw sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["cryptoclaw sandbox recreate --all", "Recreate all containers."],
    ["cryptoclaw sandbox recreate --session main", "Recreate a specific session."],
    [
      "cryptoclaw sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["cryptoclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["cryptoclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["cryptoclaw sandbox explain", "Show effective sandbox config."],
    ["cryptoclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["cryptoclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["cryptoclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "cryptoclawdocs.termix.ai/cli/sandbox")}\n`,
    )
    .action(() => {
