...
export const DEFAULT_LOG_DIR = "/tmp/cryptoclaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "cryptoclaw.log"); // legacy single-file path

const LOG_PREFIX = "cryptoclaw";
