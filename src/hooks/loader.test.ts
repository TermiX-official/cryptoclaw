...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.CRYPTOCLAW_BUNDLED_HOOKS_DIR;
    process.env.CRYPTOCLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      ...
      process.env.CRYPTOCLAW_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
