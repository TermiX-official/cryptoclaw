...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [I can't access cryptoclawdocs.termix.ai (SSL error). What now?](#i-cant-access-docsopenclawai-ssl-error-what-now)
...
### I cant access cryptoclawdocs.termix.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `cryptoclawdocs.termix.ai` via Xfinity
Advanced Security. Disable it or allowlist `cryptoclawdocs.termix.ai`, then retry. More
