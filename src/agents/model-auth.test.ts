...
describe("getApiKeyForModel", () => {
  it("migrates legacy oauth.json into auth-profiles.json", async () => {
    ...
    try {
      process.env.CRYPTOCLAW_STATE_DIR = tempDir;
      process.env.CRYPTOCLAW_AGENT_DIR = path.join(tempDir, "agent");
      ...
      const store = ensureAuthProfileStore(process.env.CRYPTOCLAW_AGENT_DIR, {
