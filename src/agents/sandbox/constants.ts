...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".cryptoclaw", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "cryptoclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "cryptoclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "cryptoclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "cryptoclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "cryptoclaw-sbx-browser-";
