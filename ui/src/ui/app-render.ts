        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="CryptoClaw" />
            </div>
            <div class="brand-text">
              <div class="brand-title">CRYPTOCLAW</div>
              <div class="brand-sub">Crypto Dashboard</div>
            </div>
          </div>
        </div>
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://cryptoclawdocs.termix.ai"
              target="_blank"
              rel="noreferrer"
